"""Real integration tests for the Adversarial Validation System using production retrieval models."""
...
class HybridRetriever:
    """Hybrid retrieval system combining web search, dense retrieval, and SerperRM reranking."""
    ...
    def _tokenwise_similarity(self, query: str, snippet: str) -> float:
        ...
        return similarity / len(query_tokens)
...
@pytest.fixture
def retriever():
    """Test fixture providing configured HybridRetriever."""
